    ...
    return (
        <div className='bg-black bg-opacity-90 m-0 font-textF'>
          ...
          focus:ring focus:ring-opacity-40"
                        ...
                        <div className="flex flex-col w-90 ml-2 mt-8">
                            <p className=' text-xs'>
                                Second name
                            </p>
                            <input type="text"
...
<div className="flex flex-col w-screen mt-8">
                            ...
                            <input type="number"
                                className="block w-96 mt-2 h-8 py-3 text-gray-700 bg-gray-50 border-2 rounded-lg px-2 dark:bg-gray-900 dark:text-gray-300
          dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none
          focus:ring focus:ring-opacity-40"
                                value={telephone}
