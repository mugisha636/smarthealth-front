...
<>
            <div className="bg-white shadow-2xl rounded-b-[50px] shadow-gray-200 sticky top-0 font-textF px-16 py-4">
                ...
                <div className='flex justify-between flex-row'>
                    ...
                    <div className="flex">
                        <NavLink to='/ChatAi'><button className='border font-bold flex flex-row rounded-lg py-2 px-3 text-blue-500 border-blue-200'>
                            WellBe chatAi
                            <img className='ml-3 h-4 mt-1' src={arrow} alt="" />
                        </button></NavLink>
			<NavLink to='/Bmi'><button className='ml-6 border font-bold flex flex-row rounded-lg py-2 px-5 text-blue-500 border-blue-200'>
                            Check BMI
                            <img className='ml-3 h-4 mt-1' src={arrow} alt="" />
                        </button></NavLink>
                    </div>
