...
<>
			...
			<NavLink to='/Login'>
                        <button className='bg-blue-500 text-white border-2 border-blue-500 py-1 px-4 justify-center font-semibold rounded-full flex flex-row'>
			...
			<NavLink to='/SignUp'>
                        <button className='ml-4 bg-white text-blue-500 border-2 border-blue-500 py-1 px-2 justify-center font-semibold rounded-full flex flex-row'>
