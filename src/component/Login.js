        ...
        <div className='bg-white'>
            <div className="flex h-screen bg-white font-textF">
                ...
                <div className="bg-blue-50 pl-16 pb-7 pt-14 w-[45%]">
                    <h1 className='text-blue-500 text-4xl -ml-6 font-extrabold'>
                        WellBe.
                    </h1>
                ...
                <div className=" w-[55%] flex flex-col px-20 pt-20">
                    ...
                    <div className="mt-14">
                        ...
                        <div className="mt-3">
                            <button className="w-full shadow-lg mt-4 px-6 py-3 text-sm font-bold tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                Login
                            </button>
